...
const logos = { 
    ...
    "AC MILAN": "https://raw.githubusercontent.com/JuanHorta03/logos-quiniela/main/logos/milan.png",
...
const partidosData = [
    ...
    ["NECAXA", "MONTERREY"],
    ["PACHUCA", "QUERETARO"],
    ["PHILADELPHIA", "SEATTLE SOUNDERS"],
    ["ORLANDO CITY", "NASHVILLE FC"],
    ["MONTREAL", "INTER MIAMI"] // Este es el partido de reserva (el décimo, índice 9)
];
